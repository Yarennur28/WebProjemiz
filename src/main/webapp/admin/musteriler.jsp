...
<%
        musteriController dboo=new musteriController();
		List<musteriModel> musteriler=dboo.readingData();
%>
                    ...
                    <tbody>
                        <%
                        		for(musteriModel musteri:musteriler){
                        			%>
                        			<tr>
                                    <th scope="row"><%=musteri.getKullaniciAdi() %></th>
                                    <td ><%=musteri.getAd() %></td>
                                    <td><%=musteri.getSoyad() %></td>
                                    <td><%=musteri.getTelefon() %></td>
                                    <td><%=musteri.geteMail() %></td>
                                    <td><%=musteri.getSifre() %></td>
                                    <td><%=musteri.getSehir() %></td>
                                    <td><%=musteri.getIlce() %></td>
                                    <td><%=musteri.getAdres() %></td>
                                    <td><button type="button" class="btn btn-secondary " data-toggle="modal" data-target="#exampleModalLong">
                                            Guncelle
                                        </button><a href="musteriSil.jsp?<%=musteri.getKullaniciAdi()%>"><button type="button" class="btn btn-danger ml-2">
                                            Sil
                                        </button></a></td>
